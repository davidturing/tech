...
![DavidAgent 仿生双脑多智能体系统架构图](davidagent_architecture_diagram_cn_final.png)

## 系统概述

DavidAgent 是一个革命性的人工智能架构，灵感来源于人类认知的仿生学双脑模型。该系统实现了复杂的双脑架构，将逻辑推理与创造性表达分离，创造出一个能够自主处理信息、合成知识并生成内容的数字生命体。
...
- `07.Metacognition_and_Self_Evolution.md` - 元认知与夜间反思
